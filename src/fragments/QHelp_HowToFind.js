          ...
          <Step id="qa_DomainKnown" name={name}>
            ...
            >
              <Step id="qa_404" name={name}>
                <Q>
                  <p>
                    Looks like you're trying to go to a specific page on your
                  ...
                  <Step id="qa_WebsiteDisconnect" name={name}>
                    <Q>
                      <p>
                        ...
                        it to your website. The web hosting company you
                        purchased it from should be able to help you with this
            ...
            <A a="Just a blank white page." goto="qa_WhiteScreen">
              <End id="qa_WhiteScreen">
                Your website likely has an issue with it's code. I can help with
                that.
                <ButtonContact />
              </End>
            </A>
            ...
            >
              <End id="qa_LooksWrong" name={name}>
                <p>
                  This may be a more complex situation, requiring some advanced
              ...
              <Step id="qa_SERP" name={name}>
                <Q>
                  <p>
                    ...
                    <span style={{ textDecoration: "underline" }}>E</span>ngine{" "}
                    <span style={{ textDecoration: "underline" }}>R</span>esults{" "}
                    <span style={{ textDecoration: "underline" }}>R</span>age).{" "}
                    Please be sure you are entering the domain name into your
                    browser's address bar with no spaces, not a search engine
                    like Google.
                  </p>
                </Q>
                <A
          ...
          <Step id="qa_NotOnGoogle" name={name}>
            <Q>
              <p>
                ...
                This should take you straight to your website. Try that and
          ...
          <Step id="qa_DomainIDK" name={name}>
            <Q>
              ...
              <p>
                ...
                Google, Squarespace, HostGater, Hostinger, BlueHost, DreamHost,{" "}
                Hostinger, Shopify, Cloudinary, 1&amp;1, etc.
              </p>
            </Q>
                  ...
                  <Step id="qa_DomainCanLoginY" name={name}>
                    <Q>
                      <p>
                        ...
                        send messages to get support. Most web hosting companies
